...
--[[
   ...
   interface_map[method] = interface_data
...
function getAllApiInfoMap()
   local dir_map = {
      app="/home/nnero/project/java/we-parent/we-service/we-api-service/weappservice/src/main/java/me/ddkj/was/api/i/",
      bbs="/home/nnero/project/java/we-parent/we-service/we-api-service/webbsservice/src/main/java/me/ddkj/webbsservice/api/i/",
      circle="/home/nnero/project/java/we-parent/we-service/we-api-service/weCircleService/src/main/java/me/ddkj/cirleservice/api/i/",
      core="/home/nnero/project/java/we-parent/we-service/we-api-service/wecoreapi/src/main/java/me/ddkj/wecore/api/",
      userinfo="/home/nnero/project/java/we-parent/we-service/we-api-service/weuserinfoapi/src/main/java/me/ddkj/weuserinfo/api/",
      small="/home/nnero/project/java/we-parent/we-service/we-api-service/wesmallservice/src/main/java/me/ddkj/small/api/i/"
   }
...
function getAllRequestInfo()
   local dir_map = {
      app="/home/nnero/project/java/we-parent/we-service/we-api-service/weappservice/src/main/java/me/ddkj/was/api/request/",
      bbs="/home/nnero/project/java/we-parent/we-service/we-api-service/webbsservice/src/main/java/me/ddkj/webbsservice/api/request/",
      core="/home/nnero/project/java/we-parent/we-service/we-api-service/wecoreapi/src/main/java/me/ddkj/wecore/api/request/",
      circle="/home/nnero/project/java/we-parent/we-service/we-api-service/weCircleService/src/main/java/me/ddkj/cirleservice/api/request/",
      userinfo="/home/nnero/project/java/we-parent/we-service/we-api-service/weuserinfoapi/src/main/java/me/ddkj/weuserinfo/api/request/",
      small="/home/nnero/project/java/we-parent/we-service/we-api-service/wesmallservice/src/main/java/me/ddkj/small/api/request/"
   }
   local files_map = getFilesMapFromDirList(dir_map)
   local result_map = {}
   for k,files in pairs(files_map) do
...
function getInterfaceMap()
   ...
   for k,api_list in pairs(api_map) do
      ...
      for _,api in pairs(api_list) do
         ...
         interface[api['method']] = method_map
      end
      result[k] = interface
   end
   return result
...
function interfaceUtil.getInterfacesInfo()
   return cjson.encode(getInterfaceMap())
end

utils.printTable(getInterfaceMap())
